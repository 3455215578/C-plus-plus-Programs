...
__09945B42_×Ö·û´®\×Ö·û´®³£Á¿@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z ; std::literals::string_literals::operator "" s
...
PUBLIC	??_C@_1O@LFMCJOEC@?$AAC?$AAh?$AAe?$AAr?$AAn?$AAo@ ; `string'
PUBLIC	??_C@_2BM@IOMJELHJ@?$AA?$AA?$AAC?$AA?$AA?$AAh?$AA?$AA?$AAe?$AA?$AA?$AAr?$AA?$AA?$AAn?$AA?$AA?$AAo@ ; `string'
PUBLIC	??_C@_07KOFAKMDO@?5Hello?$CB@			; `string'
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z DD imagerel $LN5
	DD	imagerel $LN5+109
	DD	imagerel $unwind$??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
??_C@_0BC@GBLLDDOB@Line1?6Line2?6Line3@ DB 'Line1', 0aH, 'Line2', 0aH, 'L'
	DB	'ine3', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_07KOFAKMDO@?5Hello?$CB@
CONST	SEGMENT
??_C@_07KOFAKMDO@?5Hello?$CB@ DB ' Hello!', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_2BM@IOMJELHJ@?$AA?$AA?$AAC?$AA?$AA?$AAh?$AA?$AA?$AAe?$AA?$AA?$AAr?$AA?$AA?$AAn?$AA?$AA?$AAo@
CONST	SEGMENT
??_C@_2BM@IOMJELHJ@?$AA?$AA?$AAC?$AA?$AA?$AAh?$AA?$AA?$AAe?$AA?$AA?$AAr?$AA?$AA?$AAn?$AA?$AA?$AAo@ DB 'C'
	DB	00H, 00H, 00H, 'h', 00H, 00H, 00H, 'e', 00H, 00H, 00H, 'r', 00H
	DB	00H, 00H, 'n', 00H, 00H, 00H, 'o', 00H, 00H, 00H, 00H, 00H, 00H
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1O@LFMCJOEC@?$AAC?$AAh?$AAe?$AAr?$AAn?$AAo@
CONST	SEGMENT
??_C@_1O@LFMCJOEC@?$AAC?$AAh?$AAe?$AAr?$AAn?$AAo@ DB 'C', 00H, 'h', 00H, 'e'
	DB	00H, 'r', 00H, 'n', 00H, 'o', 00H, 00H, 00H	; `string'
CONST	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??$_Reallocate_grow_by@V<lambda_1>@?1??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV34@QEBD_K@Z@PEBD_K@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV<lambda_1>@?1??append@01@QEAAAEAV01@QEBD0@Z@PEBD_K@Z DD 035054c19H
	DD	011d3322H
	DD	070160045H
	DD	05015H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??R<lambda_1>@?1??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@QEBD_K@Z@QEBA@QEAD0101@Z DD 025052201H
	DD	011d2322H
	DD	070160021H
	DD	05015H
xdata	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@QEBD_K@Z DD 025051d11H
	DD	0118231dH
	DD	070110021H
	DD	05010H
	DD	imagerel __CxxFrameHandler4
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z DD 025051d01H
	DD	0118231dH
	DD	070110021H
	DD	05010H
xdata	ENDS
...
; Line 4794
	...
	lea	rdx, OFFSET FLAT:??$_Reallocate_grow_by@V<lambda_1>@?1??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV34@QEBD_K@Z@PEBD_K@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV<lambda_1>@?1??append@01@QEAAAEAV01@QEBD0@Z@PEBD_K@Z$rtcFrameData
	call	_RTC_CheckStackVars
	mov	rax, rdi
	mov	rcx, QWORD PTR __$ArrayPad$[rbp]
	xor	rcx, rbp
...
__$ArrayPad$ = 520
main	PROC						; COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\×Ö·û´®\×Ö·û´®³£Á¿.cpp
; Line 7
$LN5:
	push	rbp
	push	rdi
	...
	xor	rax, rbp
	mov	QWORD PTR __$ArrayPad$[rbp], rax
	lea	rcx, OFFSET FLAT:__09945B42_×Ö·û´®\×Ö·û´®³£Á¿@cpp
	call	__CheckForDebuggerJustMyCode
; Line 12
	lea	rax, OFFSET FLAT:??_C@_06MDBPMDDK@Cherno@
	mov	QWORD PTR name$[rbp], rax
; Line 16
	lea	rax, OFFSET FLAT:??_C@_1O@LFMCJOEC@?$AAC?$AAh?$AAe?$AAr?$AAn?$AAo@
	mov	QWORD PTR name2$[rbp], rax
; Line 20
	lea	rax, OFFSET FLAT:??_C@_1O@LFMCJOEC@?$AAC?$AAh?$AAe?$AAr?$AAn?$AAo@
	mov	QWORD PTR name3$[rbp], rax
; Line 23
	lea	rax, OFFSET FLAT:??_C@_2BM@IOMJELHJ@?$AA?$AA?$AAC?$AA?$AA?$AAh?$AA?$AA?$AAe?$AA?$AA?$AAr?$AA?$AA?$AAn?$AA?$AA?$AAo@
	mov	QWORD PTR name4$[rbp], rax
; Line 29
	mov	r8d, 6
	lea	rdx, OFFSET FLAT:??_C@_06MDBPMDDK@Cherno@
	lea	rcx, QWORD PTR $T4[rbp]
	call	??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z ; std::literals::string_literals::operator "" s
	mov	QWORD PTR tv90[rbp], rax
	mov	rax, QWORD PTR tv90[rbp]
	mov	QWORD PTR tv87[rbp], rax
	lea	r8, OFFSET FLAT:??_C@_07KOFAKMDO@?5Hello?$CB@
	mov	rdx, QWORD PTR tv87[rbp]
	lea	rcx, QWORD PTR name0$[rbp]
...
; Line 34
	lea	rax, OFFSET FLAT:??_C@_0BC@GBLLDDOB@Line1?6Line2?6Line3@
	mov	QWORD PTR example$[rbp], rax
; Line 37
	mov	rdx, QWORD PTR example$[rbp]
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z
_TEXT	SEGMENT
$T1 = 196
__$ReturnUdt$ = 256
_Str$ = 264
_Len$ = 272
??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z PROC ; std::literals::string_literals::operator "" s, COMDAT
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.37.32822\include\xstring
; Line 5192
$LN5:
	mov	QWORD PTR [rsp+24], r8
...
; Line 5194
	...
	pop	rbp
	ret	0
??__Ks@string_literals@literals@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@3@PEBD_K@Z ENDP ; std::literals::string_literals::operator "" s
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
