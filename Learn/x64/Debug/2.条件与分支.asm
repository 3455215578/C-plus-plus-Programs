...
PUBLIC	??_C@_0BB@OGCKJAAA@Pointer?5is?5Hello@		; `string'
PUBLIC	??_C@_0BB@DJMFIDCC@Pointer?5is?5null?$CB@	; `string'
EXTRN	strlen:PROC
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?main02@@YAHXZ DD imagerel $LN7
	DD	imagerel $LN7+176
	DD	imagerel $unwind$?main02@@YAHXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BB@DJMFIDCC@Pointer?5is?5null?$CB@
CONST	SEGMENT
??_C@_0BB@DJMFIDCC@Pointer?5is?5null?$CB@ DB 'Pointer is null!', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@OGCKJAAA@Pointer?5is?5Hello@
CONST	SEGMENT
??_C@_0BB@OGCKJAAA@Pointer?5is?5Hello@ DB 'Pointer is Hello', 00H ; `string'
CONST	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?main02@@YAHXZ DD 025050f01H
	DD	010a230fH
	DD	070030021H
	DD	05002H
xdata	ENDS
...
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\2.条件与分支.cpp
; Line 4
$LN7:
	push	rbp
	push	rdi
	sub	rsp, 264				; 00000108H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__4E30078D_2@条件与分支@cpp
	call	__CheckForDebuggerJustMyCode
; Line 7
...
; Line 10
	...
	jmp	SHORT $LN3@main02
$LN2@main02:
; Line 11
	lea	rax, OFFSET FLAT:??_C@_05COLMCDPH@Hello@
	cmp	QWORD PTR ptr$[rbp], rax
	jne	SHORT $LN4@main02
; Line 12
	lea	rdx, OFFSET FLAT:??_C@_0BB@OGCKJAAA@Pointer?5is?5Hello@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	lea	rdx, OFFSET FLAT:??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	rcx, rax
	call	QWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@P6AAEAV01@AEAV01@@Z@Z
	jmp	SHORT $LN5@main02
$LN4@main02:
; Line 14
	lea	rdx, OFFSET FLAT:??_C@_0BB@DJMFIDCC@Pointer?5is?5null?$CB@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	lea	rdx, OFFSET FLAT:??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	rcx, rax
