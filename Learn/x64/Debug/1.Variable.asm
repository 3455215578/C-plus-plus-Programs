...
__5AF0E4A1_1@Variable@cpp DB 01H
msvcjmc	ENDS
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?main1@@YAHXZ DD imagerel $LN3
	DD	imagerel $LN3+209
	DD	imagerel $unwind$?main1@@YAHXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?main1@@YAHXZ DD 025050f01H
	DD	010a230fH
	DD	070030031H
	DD	05002H
xdata	ENDS
...
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\1.Variable.cpp
; Line 4
$LN3:
	push	rbp
	push	rdi
	...
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__5AF0E4A1_1@Variable@cpp
	call	__CheckForDebuggerJustMyCode
; Line 9
