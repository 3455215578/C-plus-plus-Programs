...
__CD25EF4B_Log@h DB 01H
__50574329_Log@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	?Init_Log@@YAXPEBD@Z				; Init_Log
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?Init_Log@@YAXPEBD@Z DD imagerel $LN3
	DD	imagerel $LN3+53
	DD	imagerel $unwind$?Init_Log@@YAXPEBD@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Init_Log@@YAXPEBD@Z DD 025051301H
	DD	010e2313H
	DD	07007001dH
	DD	05006H
xdata	ENDS
...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?Init_Log@@YAXPEBD@Z
_TEXT	SEGMENT
message$ = 224
?Init_Log@@YAXPEBD@Z PROC				; Init_Log, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Log.cpp
; Line 13
$LN3:
	mov	QWORD PTR [rsp+8], rcx
	push	rbp
	...
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__50574329_Log@cpp
	call	__CheckForDebuggerJustMyCode
; Line 14
...
; Line 15
	...
	pop	rbp
	ret	0
?Init_Log@@YAXPEBD@Z ENDP				; Init_Log
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
