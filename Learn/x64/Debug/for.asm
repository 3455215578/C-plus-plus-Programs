...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?main03@@YAHXZ DD imagerel $LN7
	DD	imagerel $LN7+109
	DD	imagerel $unwind$?main03@@YAHXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?main03@@YAHXZ DD 025050f01H
	DD	010a230fH
	DD	070030021H
	DD	05002H
xdata	ENDS
...
$LN4@main03:
	...
	jge	SHORT $LN3@main03
; Line 61
	cmp	DWORD PTR i$1[rbp], 2
	jle	SHORT $LN5@main03
; Line 62
	xor	eax, eax
	jmp	SHORT $LN1@main03
$LN5@main03:
; Line 64
