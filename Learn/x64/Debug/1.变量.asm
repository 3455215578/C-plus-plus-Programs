...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?main01@@YAHXZ DD imagerel $LN3
	DD	imagerel $LN3+209
	DD	imagerel $unwind$?main01@@YAHXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?main01@@YAHXZ DD 025050f01H
	DD	010a230fH
	DD	070030031H
	DD	05002H
xdata	ENDS
...
d$ = 100
variable$ = 132
?main01@@YAHXZ PROC					; main01, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\1.变量.cpp
; Line 4
$LN3:
	push	rbp
	push	rdi
	...
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__3BE78894_1@变量@cpp
	call	__CheckForDebuggerJustMyCode
; Line 9
	mov	BYTE PTR a$[rbp], 65			; 00000041H
; Line 10
	mov	BYTE PTR b$[rbp], 65			; 00000041H
; Line 11
...
; Line 15
	...
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	QWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@F@Z
	lea	rdx, OFFSET FLAT:??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	rcx, rax
	call	QWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@P6AAEAV01@AEAV01@@Z@Z
; Line 18
	movss	xmm0, DWORD PTR __real@40b00000
	movss	DWORD PTR d$[rbp], xmm0
; Line 21
	mov	BYTE PTR variable$[rbp], 1
; Line 22
	movzx	edx, BYTE PTR variable$[rbp]
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
