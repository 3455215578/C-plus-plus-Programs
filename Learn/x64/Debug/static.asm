...
__A2C9655F_static@cpp DB 01H
msvcjmc	ENDS
PUBLIC	?__empty_global_delete@@YAXPEAX@Z		; __empty_global_delete
PUBLIC	?__empty_global_delete@@YAXPEAX_K@Z		; __empty_global_delete
PUBLIC	?Print@Entity@@SAXXZ				; Entity::Print
PUBLIC	?main09@@YAHXZ					; main09
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?Print@Entity@@SAXXZ DD imagerel $LN3
	DD	imagerel $LN3+37
	DD	imagerel $unwind$?Print@Entity@@SAXXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?main09@@YAHXZ DD imagerel $LN3
	DD	imagerel $LN3+114
	DD	imagerel $unwind$?main09@@YAHXZ
pdata	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?main09@@YAHXZ DD 025052001H
	DD	010a230fH
	DD	070030025H
	DD	05002H
xdata	ENDS
;	COMDAT CONST
CONST	SEGMENT
?main09@@YAHXZ$rtcName$0 DB 065H			; main09
	DB	00H
	ORG $+2
?main09@@YAHXZ$rtcName$1 DB 065H			; main09
	DB	031H
	DB	00H
	ORG $+9
?main09@@YAHXZ$rtcVarDesc DD 048H			; main09
	DD	08H
	DQ	FLAT:?main09@@YAHXZ$rtcName$1
	DD	028H
	DD	08H
	DQ	FLAT:?main09@@YAHXZ$rtcName$0
	ORG $+96
?main09@@YAHXZ$rtcFrameData DD 02H			; main09
	DD	00H
	DQ	FLAT:?main09@@YAHXZ$rtcVarDesc
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Print@Entity@@SAXXZ DD 025050f01H
	DD	010a230fH
	DD	07003001dH
	DD	05002H
xdata	ENDS
...
e$ = 8
e1$ = 40
?main09@@YAHXZ PROC					; main09, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\static.cpp
; Line 30
$LN3:
	push	rbp
	push	rdi
	...
	rep stosd
	lea	rcx, OFFSET FLAT:__A2C9655F_static@cpp
	call	__CheckForDebuggerJustMyCode
; Line 32
	mov	DWORD PTR e$[rbp], 2
; Line 33
	mov	DWORD PTR e$[rbp+4], 5
; Line 38
	mov	DWORD PTR e1$[rbp], 3
; Line 39
	mov	DWORD PTR e1$[rbp+4], 8
; Line 41
	call	?Print@Entity@@SAXXZ			; Entity::Print
; Line 42
	call	?Print@Entity@@SAXXZ			; Entity::Print
; Line 44
	xor	eax, eax
; Line 45
	...
	lea	rdx, OFFSET FLAT:?main09@@YAHXZ$rtcFrameData
	...
	pop	rbp
	ret	0
?main09@@YAHXZ ENDP					; main09
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?Print@Entity@@SAXXZ
_TEXT	SEGMENT
?Print@Entity@@SAXXZ PROC				; Entity::Print, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\static.cpp
; Line 20
$LN3:
	push	rbp
...
; Line 22
	...
	pop	rbp
	ret	0
?Print@Entity@@SAXXZ ENDP				; Entity::Print
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
