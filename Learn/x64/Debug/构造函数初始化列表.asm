...
__DC48DFF6_类\构造函数初始化列表@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	?GetName@Entity@@QEAAXXZ			; Entity::GetName
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??0Entity@@QEAA@XZ DD imagerel $LN4
	DD	imagerel $LN4+98
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?GetName@Entity@@QEAAXXZ DD imagerel $LN3
	DD	imagerel $LN3+162
	DD	imagerel $unwind$?GetName@Entity@@QEAAXXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?GetName@Entity@@QEAAXXZ DD 025051301H
	DD	010e2313H
	DD	07007001fH
	DD	05006H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$??0Entity@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z DD 025051801H
	DD	01132318H
	DD	0700c001dH
	DD	0500bH
xdata	ENDS
...
__$ArrayPad$ = 440
main	PROC						; COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\类\构造函数初始化列表.cpp
; Line 45
$LN6:
	push	rbp
	push	rdi
	...
	xor	rax, rbp
	mov	QWORD PTR __$ArrayPad$[rbp], rax
	lea	rcx, OFFSET FLAT:__DC48DFF6_类\构造函数初始化列表@cpp
	call	__CheckForDebuggerJustMyCode
; Line 46
...
; Line 49
	lea	rcx, QWORD PTR e0$[rbp]
	call	?GetName@Entity@@QEAAXXZ		; Entity::GetName
; Line 50
	lea	rcx, QWORD PTR e1$[rbp]
	call	?GetName@Entity@@QEAAXXZ		; Entity::GetName
; Line 53
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?GetName@Entity@@QEAAXXZ
_TEXT	SEGMENT
tv65 = 192
this$ = 240
?GetName@Entity@@QEAAXXZ PROC				; Entity::GetName, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\类\构造函数初始化列表.cpp
; Line 37
$LN3:
	mov	QWORD PTR [rsp+8], rcx
...
; Line 40
	...
	pop	rbp
	ret	0
?GetName@Entity@@QEAAXXZ ENDP				; Entity::GetName
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
...
; Line 31
	...
	mov	rax, QWORD PTR this$[rbp]
	mov	DWORD PTR [rax+44], 233			; 000000e9H
; Line 34
	mov	rax, QWORD PTR this$[rbp]
	lea	rsp, QWORD PTR [rbp+200]
	pop	rdi
