...
__$ArrayPad$ = 392
main	PROC						; COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\数组.cpp
; Line 5
$LN9:
	push	rbp
	push	rdi
	...
	lea	rcx, OFFSET FLAT:__79930F92_数组@cpp
	call	__CheckForDebuggerJustMyCode
; Line 9
	lea	rax, QWORD PTR example$[rbp]
...
; Line 13
	...
	mov	DWORD PTR example$[rbp+rax*4], 2
; Line 14
	jmp	SHORT $LN2@main
$LN3@main:
; Line 19
