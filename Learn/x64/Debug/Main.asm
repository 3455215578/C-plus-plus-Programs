...
ch$2 = 100
main	PROC						; COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Main.cpp
; Line 5
$LN6:
	push	rbp
	push	rdi
	...
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__9B956120_Main@cpp
	call	__CheckForDebuggerJustMyCode
; Line 6
	mov	DWORD PTR a$[rbp], 8
; Line 8
...
; Line 12
	...
	mov	BYTE PTR ch$2[rbp], al
; Line 13
	movzx	edx, BYTE PTR ch$2[rbp]
