...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?main04@@YAHXZ DD imagerel $LN5
	DD	imagerel $LN5+97
	DD	imagerel $unwind$?main04@@YAHXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?main04@@YAHXZ DD 025050f01H
	DD	010a230fH
	DD	070030021H
	DD	05002H
xdata	ENDS
...
_TEXT	SEGMENT
i$ = 4
?main04@@YAHXZ PROC					; main04, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\循环和控制流\while.cpp
; Line 4
$LN5:
	push	rbp
	push	rdi
	sub	rsp, 264				; 00000108H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__13628CD6_while@cpp
	call	__CheckForDebuggerJustMyCode
; Line 6
	mov	DWORD PTR i$[rbp], 0
$LN2@main04:
; Line 7
	cmp	DWORD PTR i$[rbp], 5
	jge	SHORT $LN3@main04
; Line 9
