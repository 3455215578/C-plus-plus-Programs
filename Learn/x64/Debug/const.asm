...
__20EB8EDC_const@cpp DB 01H
msvcjmc	ENDS
PUBLIC	?__empty_global_delete@@YAXPEAX@Z		; __empty_global_delete
PUBLIC	?__empty_global_delete@@YAXPEAX_K@Z		; __empty_global_delete
PUBLIC	?GetX@Entity@@QEBAHXZ				; Entity::GetX
PUBLIC	?PrintEntity@@YAXAEBVEntity@@@Z			; PrintEntity
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?GetX@Entity@@QEBAHXZ DD imagerel $LN3
	DD	imagerel $LN3+50
	DD	imagerel $unwind$?GetX@Entity@@QEBAHXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?PrintEntity@@YAXAEBVEntity@@@Z DD imagerel $LN3
	DD	imagerel $LN3+84
	DD	imagerel $unwind$?PrintEntity@@YAXAEBVEntity@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?PrintEntity@@YAXAEBVEntity@@@Z DD 025051301H
	DD	010e2313H
	DD	07007001dH
	DD	05006H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?GetX@Entity@@QEBAHXZ DD 025051301H
	DD	010e2313H
	DD	07007001dH
	DD	05006H
xdata	ENDS
...
MAX_AGE$ = 4
main	PROC						; COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\const.cpp
; Line 31
$LN3:
	push	rbp
	push	rdi
	...
	lea	rcx, OFFSET FLAT:__20EB8EDC_const@cpp
	call	__CheckForDebuggerJustMyCode
; Line 32
	mov	DWORD PTR MAX_AGE$[rbp], 90		; 0000005aH
; Line 44
	xor	eax, eax
; Line 45
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?PrintEntity@@YAXAEBVEntity@@@Z
_TEXT	SEGMENT
entity$ = 224
?PrintEntity@@YAXAEBVEntity@@@Z PROC			; PrintEntity, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\const.cpp
; Line 26
$LN3:
	mov	QWORD PTR [rsp+8], rcx
...
; Line 27
	...
	call	?GetX@Entity@@QEBAHXZ			; Entity::GetX
	mov	edx, eax
...
; Line 28
	...
	pop	rbp
	ret	0
?PrintEntity@@YAXAEBVEntity@@@Z ENDP			; PrintEntity
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?GetX@Entity@@QEBAHXZ
_TEXT	SEGMENT
this$ = 224
?GetX@Entity@@QEBAHXZ PROC				; Entity::GetX, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\const.cpp
; Line 12
$LN3:
	mov	QWORD PTR [rsp+8], rcx
...
; Line 16
	...
	pop	rbp
	ret	0
?GetX@Entity@@QEBAHXZ ENDP				; Entity::GetX
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
