...
PUBLIC	??0Entity@@QEAA@MM@Z				; Entity::Entity
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??0Entity@@QEAA@MM@Z DD imagerel $LN3
	DD	imagerel $LN3+99
	DD	imagerel $unwind$??0Entity@@QEAA@MM@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?main10@@YAHXZ DD imagerel $LN3
	DD	imagerel $LN3+142
	DD	imagerel $unwind$?main10@@YAHXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?main10@@YAHXZ DD 025053119H
	DD	010a230fH
	DD	070030021H
	DD	05002H
...
;	COMDAT CONST
CONST	SEGMENT
?main10@@YAHXZ$rtcName$0 DB 065H			; main10
	DB	00H
	ORG $+14
?main10@@YAHXZ$rtcVarDesc DD 028H			; main10
	DD	08H
	DQ	FLAT:?main10@@YAHXZ$rtcName$0
	ORG $+48
?main10@@YAHXZ$rtcFrameData DD 01H			; main10
	DD	00H
	DQ	FLAT:?main10@@YAHXZ$rtcVarDesc
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$??0Entity@@QEAA@MM@Z DD 025051f01H
	DD	011a231fH
	DD	07013001dH
	DD	05012H
xdata	ENDS
...
e$ = 8
__$ArrayPad$ = 216
?main10@@YAHXZ PROC					; main10, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\构造函数.cpp
; Line 27
$LN3:
	push	rbp
	push	rdi
	...
	lea	rcx, OFFSET FLAT:__41A92CB9_构造函数@cpp
	call	__CheckForDebuggerJustMyCode
; Line 29
	movss	xmm2, DWORD PTR __real@40a00000
	movss	xmm1, DWORD PTR __real@40000000
	lea	rcx, QWORD PTR e$[rbp]
	call	??0Entity@@QEAA@MM@Z			; Entity::Entity
; Line 30
	lea	rcx, QWORD PTR e$[rbp]
...
; Line 33
	...
	lea	rdx, OFFSET FLAT:?main10@@YAHXZ$rtcFrameData
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??0Entity@@QEAA@MM@Z
_TEXT	SEGMENT
this$ = 224
x$ = 232
y$ = 240
??0Entity@@QEAA@MM@Z PROC				; Entity::Entity, COMDAT
; File D:\GitHub\Code\C-plus-plus-Programs\Learn\Src\构造函数.cpp
; Line 14
$LN3:
...
; Line 18
	...
	pop	rbp
	ret	0
??0Entity@@QEAA@MM@Z ENDP				; Entity::Entity
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
